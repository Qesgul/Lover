package com.jizhi.lover.view.calendar;
...
import com.jizhi.lover.Utils.ScreenHelper;
import com.jizhi.lover.Utils.TimeTools;
...
public class CalendarFactory {
    ...
    public CalendarFactory(Context context, Calendar calendar , int width, int height) {
        ...
        monthPaint.setColor(context.getResources().getColor(R.color.themeColor_mistuha));
        monthPaint.setTextAlign(Paint.Align.CENTER);

        datePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        setPrintTextSize(datePaint,130);
        datePaint.setColor(context.getResources().getColor(R.color.themeColor_mistuha));
        datePaint.setTextAlign(Paint.Align.CENTER);
        datePaint.setTypeface(Typeface.DEFAULT_BOLD);

        dayPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        setPrintTextSize(dayPaint,25);
        dayPaint.setColor(context.getResources().getColor(R.color.themeColor_mistuha));
