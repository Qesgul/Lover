package com.jizhi.bill.adapter;
...
import com.jizhi.bill.view.SwipeMenuView;
...
public class BillDetailAdapter extends StickyHeaderGridAdapter {
   ...
   public BillDetailAdapter(Context context, List<TallyDetailBean.DaylistBean> datas){
